...
import '../components/video_memos_subscriptions_widget.dart';
                                                    ...
                                                    itemBuilder: (context, _,
                                                      ...
                                                      return Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'VIEWER_PAGE_Container_em7hvbi3_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Container_Revenue-Cat');
                                                            final isEntitled =
                                                                await revenue_cat
                                                                    .isEntitled(
                                                                        'etwelve_papers_videos');
                                                            if (isEntitled ==
                                                                null) {
                                                              return;
                                                            } else if (!isEntitled) {
                                                              ...
                                                              children: [
                                                                ...
                                                                InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'VIEWER_PAGE_Icon_no8t2gqd_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_Revenue-Cat');
                                                                    final isEntitled =
                                                                        await revenue_cat
                                                                            .isEntitled('etwelve_papers_videos');
                                                                    if (isEntitled ==
                                                                        null) {
                                                                      return;
                                                                    } else if (!isEntitled) {
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: VideoMemosSubscriptionsWidget(),
                                                                            ),
                                                                          );
                                                                        },
                                                                      ).then((value) =>
